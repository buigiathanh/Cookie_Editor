            ...
            <div className={`w-full flex flex-wrap justify-right mb-[5px]`}>
                ...
                <>
                    <div
                        ...
                        data-tooltip-placement="bottom"
                        className={`hidden h-[30px] w-[30px] bg-[#3C3C3C] me-2 mb-2 last:mb-0 text-white rounded flex items-center cursor-pointer group hover:bg-white hover:text-gray-800`}>
