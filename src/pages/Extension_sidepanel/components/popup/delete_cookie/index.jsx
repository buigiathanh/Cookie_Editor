...
const DeleteCookie = ({cookie}) => {
    ...
    return (
        <>
            {
                (settingStore.popup === "delete_cookie" && cookie) && (
                    <>
                        <ModalPopup />
                        <motion.div
                            ref={ref}
                        ...
                        >
                            <div className={`bg-white rounded-[10px] p-5`}>
                                <p className={`font-bold text-[14px] mb-2`}>
                                    {extension.getLang("title_delete_cookie")}
                                </p>
                                <p className={`text-[12px] mb-5`}>
                                    {extension.getLang("description_delete_cookie")}
                                </p>
...
export default observer(DeleteCookie)